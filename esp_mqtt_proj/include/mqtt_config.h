...
#define MQTT_HOST            "192.168.0.17" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "ESP-SB"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define STA_SSID "D-Link_DIR-816_SS"    // your AP/router SSID to config your device networking
#define STA_PASS "K6PG988MEH" // your AP/router password
